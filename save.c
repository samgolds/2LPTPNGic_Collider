...
void write_phi_lin_field_data(void)
{
  ...
  */
  ...
  for (groupTask = 0; groupTask < nprocgroup; groupTask++)
  {
    ...
    {
      // save coordinates, amplitudes and phases here
      sprintf(buf, "%s/linear_fields/Coordinates_lin_ptype_%d.%d", OutputDir, 1, ThisTask); // Sam changed "Type" to "0" for single coordinate
      fd = fopen(buf, "w");
      my_fwrite(&NTaskWithN, sizeof(int), 1, fd); // save the number of subfiles
      my_fwrite(&Nmesh, sizeof(int), 1, fd);      // save Nmesh
      my_fwrite(&Local_nx, sizeof(int), 1, fd);   // save Local_nx
      ...
      sprintf(buf, "%s/linear_fields/phi_lin_ptype_%d.%d", OutputDir, 1, ThisTask);
      fd = fopen(buf, "w");
      my_fwrite(&NTaskWithN, sizeof(int), 1, fd); // save the number of subfiles
      my_fwrite(&Nmesh, sizeof(int), 1, fd);      // save Nmesh
      my_fwrite(&Local_nx, sizeof(int), 1, fd);   // save Local_nx
      ...
      sprintf(buf, "%s/linear_fields/Coordinates_i_ptype_%d.%d", OutputDir, 1, ThisTask); // Sam changed "Type" to "0" for single coordinate
      fd = fopen(buf, "w");
      my_fwrite(&NTaskWithN, sizeof(int), 1, fd); // save the number of subfiles
      my_fwrite(&Nmesh, sizeof(int), 1, fd);      // save Nmesh
      my_fwrite(&Local_nx, sizeof(int), 1, fd);   // save Local_nx
      ...
      sprintf(buf, "%s/linear_fields/Coordinates_j_ptype_%d.%d", OutputDir, 1, ThisTask); // Sam changed "Type" to "0" for single coordinate
      fd = fopen(buf, "w");
      my_fwrite(&NTaskWithN, sizeof(int), 1, fd); // save the number of subfiles
      my_fwrite(&Nmesh, sizeof(int), 1, fd);      // save Nmesh
      my_fwrite(&Local_nx, sizeof(int), 1, fd);   // save Local_nx
      ...
      sprintf(buf, "%s/linear_fields/Coordinates_k_ptype_%d.%d", OutputDir, 1, ThisTask); // Sam changed "Type" to "0" for single coordinate
      fd = fopen(buf, "w");
      my_fwrite(&NTaskWithN, sizeof(int), 1, fd); // save the number of subfiles
      my_fwrite(&Nmesh, sizeof(int), 1, fd);      // save Nmesh
      my_fwrite(&Local_nx, sizeof(int), 1, fd);   // save Local_nx
